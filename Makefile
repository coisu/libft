...
#    Updated: 2022/06/09 16:45:55 by jischoi          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC		= ft_bzero.c ft_calloc.c ft_memset.c ft_memchr.c ft_memcpy.c\
		ft_memmove.c ft_memcmp.c ft_strdup.c ft_strchr.c ft_strrchr.c\
		ft_strnstr.c ft_toupper.c ft_tolower.c ft_isalnum.c ft_isalpha.c\
		ft_isascii.c ft_isdigit.c ft_isprint.c ft_strlen.c ft_atoi.c\
